      ...
      >
        ...
        <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl dark:shadow-2xl space-y-8">
          ...
          <div className="space-y-4">
            ...
            <label className="relative group block w-full aspect-video md:aspect-[21/9] rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-900 border-2 border-dashed border-slate-300 dark:border-white/10 hover:border-orange-500 dark:hover:border-orange-500/50 transition-all cursor-pointer shadow-inner">
                    ...
                    {expandedDays.includes(day.id) && (
                      <div className="p-4 pt-0 border-t border-slate-200 dark:border-white/5 grid md:grid-cols-12 gap-6 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        <div className="md:col-span-4 space-y-4">
                          <label className="block aspect-[4/3] rounded-xl bg-slate-200 dark:bg-black/20 border border-slate-300 dark:border-white/5 overflow-hidden relative cursor-pointer hover:border-slate-400 dark:hover:border-white/20 transition-all group/img">
                            {day.imagePreview ? (
                              <>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
               ...
               <div className="relative">
                 ...
                 <textarea
                   className="w-full h-40 bg-slate-100 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl p-4 pl-12 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-white/20 focus:outline-none focus:border-yellow-500 transition-colors resize-none"
            ...
            <div className="space-y-4">
               ...
               <div className="relative">
                 ...
                 <textarea
                   className="w-full h-40 bg-slate-100 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl p-4 pl-12 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-white/20 focus:outline-none focus:border-red-500 transition-colors resize-none"
              ...
              <div className="bg-red-50 dark:bg-red-500/5 border border-red-200 dark:border-red-500/20 rounded-xl p-4 animate-in fade-in slide-in-from-top-2">
                <div className="flex items-center gap-3">
                  ...
                  <input 
                    ...
                    className="flex-1 bg-white dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-3 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-white/30 focus:outline-none focus:border-red-500"
                  />
                </div>
              </div>
            )}
    ...
    return (
        <div className={`space-y-1 relative ${isOpen ? "z-50" : "z-0"}`}>
            ...
            <button 
                ...
                className="w-full bg-slate-100 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 text-left flex items-center justify-between text-slate-900 dark:text-white hover:border-orange-500 transition-colors focus:outline-none"
            >
                {selectedOption ? (
                    <div className="flex items-center gap-2">
                         {selectedOption.icon && (
...
const InputGroup = ({ label, value, onChange, placeholder, type = "text", min, onKeyDown }) => (
  <div className="space-y-1">
    ...
    <input 
      ...
      className="w-full bg-slate-100 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-white/20 focus:outline-none focus:border-orange-500 transition-colors"
    />
  </div>
);